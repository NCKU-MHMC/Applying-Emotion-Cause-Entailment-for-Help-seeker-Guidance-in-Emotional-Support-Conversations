...
class Model(BaseModel, BlenderbotSmallForConditionalGeneration):
    ...
    def predict_strategy(self, logits, encoded_info, logits_processor):
        assert not self.training
        ...
        if strat_id is not None:
            ...
            if SAMPLE:
                ...
                filtered_logits = logits_processor(logits / TEMPERATURE)
    ...
    def generate(
        ...
        **kwargs
        ...
        logits_processor.append(TopPLogitsWarper(top_p=0.9))
        
        self.predict_strategy(lm_logits, encoded_info, logits_processor)
        ...
        if 'strat_id' in kwargs:
            del kwargs['strat_id']
        del kwargs['batch_size']
        del kwargs['other_res']
        del kwargs['pred_strat_id']
        del kwargs['pred_strat_id_top1']
        del kwargs['pred_strat_id_top3']
        del kwargs['pred_strat_id_dist']
